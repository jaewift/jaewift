  ...
  return (
    <Reveal>
      <section className="w-full max-w-440 mx-auto px-4 flex flex-col text-center relative xl:mb-32 mb-16">
        <p className="md:text-2xl sm:text-lg whitespace-pre-wrap leading-[180%] border-y border-border bg-gradient-to-b from-primary/5 via-transparent to-primary/5 xl:px-20 px-12 py-20 lg:mx-8 italic font-semibold">
          {personalInfo.values}
        </p>
